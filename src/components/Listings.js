    ...
    <div>
      <Section>
        <Container>
          ...
          <InfoRow>
            <InfoWrap data-aos='zoom-out-up'
            data-aos-duration='1200'
            data-aos-once='true'
            data-aos-anchor-placement='center bottom'>
              <Image alt="" src={HomeOne} />
            ...
            <InfoWrap data-aos='zoom-out-down'
            data-aos-duration='1200'
            data-aos-once='true'
            data-aos-anchor-placement='center bottom'>
              <Image alt="" src={HomeTwo} css={`margin-top: 120px; @media screen and (max-width: 768px) {margin-top: 0px;}`} />
